...
const clickData = document.querySelector(".Button_Clicked span");


// Log when the button is clicked in the console.
let butttonClicked = 0;
button.addEventListener("click", () => {
  button.classList.toggle("active");
  console.log("Button was clicked!");
  butttonClicked+=1;
  clickData.innerText = butttonClicked;
  console.log("Button was clicked!",butttonClicked);
}, false);
